...
public class LeaderSelectorExample {
    ...
    public static final String LEADER_PATH = "/examples/leader";

    public static final String MASTER_PATH = "/examples/master";
    ...
    public static void main(String[] args) throws Exception {
        ...
        try {
            for (int i = 0; i < CLIENT_QTY; ++i) {
                ...
                ExampleClient example = new ExampleClient(client, LEADER_PATH, "Client #" + i);
